...
Route::patch('/users/{user:id}/balance/decrement_user', [BalanceController::class, 'decrement_user']);
Route::get('/users/balance', [BalanceController::class, 'index']);
...
// JackpotMarket Games
Route::post('jackpots/markets/{market_id}/games', [JackpotGamesController::class, 'store']);
Route::get('jackpots/{market_id}/games', [JackpotGamesController::class, 'index']);
Route::patch('jackpots/{market_id}/patch', [JackpotGamesController::class, 'patch']);
...
Route::post('jackpots/{market_id}/users/{user_id}/games', [JackpotGamesController::class, 'store_games']);
